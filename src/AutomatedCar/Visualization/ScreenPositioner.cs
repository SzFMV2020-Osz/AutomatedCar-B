namespace AutomatedCar
{
    ...
    public class ScreenPositioner 
    {
        ...
        public void AlignItemsToScreen(World world) { 
            ...
            world.ControlledCar.VisibleX = ComputeCarPositionHorisontal(world, world.VisibleWidth/2);
            world.ControlledCar.VisibleY = computeCarPositionVertical(world, world.VisibleHeight/2);
        }
