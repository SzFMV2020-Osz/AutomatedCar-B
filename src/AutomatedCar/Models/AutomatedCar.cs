namespace AutomatedCar.Models
{
    ...
    public class AutomatedCar : WorldObject, IMoveable
    {
        ...
        {
            get => radarVisible;
            set => this.RaiseAndSetIfChanged(ref radarVisible, value); // virtualFunctionBus.DebugPacket.RadarSensor); A HMI olvas�s hi�ny�ban most mockolt adattal jelen�tj�k meg.
        }
        ...
        public bool UltraSoundVisible
        {
            ...
            set => this.RaiseAndSetIfChanged(ref ultraSoundVisible, value); //virtualFunctionBus.DebugPacket.UtrasoundSensor); A HMI olvas�s hi�ny�ban most mockolt adattal jelen�tj�k meg.
        }
        ...
        {
            get => cameraVisible;
            set => this.RaiseAndSetIfChanged(ref cameraVisible, value); //virtualFunctionBus.DebugPacket.BoardCamera); A HMI olvas�s hi�ny�ban most mockolt adattal jelen�tj�k meg.
        }
